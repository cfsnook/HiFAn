...
/**
 * This is the item provider adapter for a {@link ac.soton.hifan.Failure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FailureItemProvider extends LabeledElementItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Failure) object).getLabel();
		return label == null || label.length() == 0 ? getString("_UI_Failure_type")
